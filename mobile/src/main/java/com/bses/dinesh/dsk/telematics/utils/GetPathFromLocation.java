...
public class GetPathFromLocation extends AsyncTask<String, Void, PolylineOptions> {
    ...
    private String API_KEY = "AIzaSyC3US8ADVe4nOqCoDerq9mYBZxu1p6b6X8";

    private LatLng source, destination;
    private String waypoints;
    private DirectionPointListener resultCallback;

    public GetPathFromLocation(LatLng source, LatLng destination,String waypoints,
    ...
    public String getUrl(LatLng origin, LatLng dest,String waypoints)
    {
